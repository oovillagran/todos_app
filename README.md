...
In the **To Do List App**, I followed the tutorial: [React Tutorial From Scratch: A Step-by-Step Guide (2021)](https://ibaslogic.com/react-tutorial-for-beginners/), where I developed a To do app!. In This application I consolidated my knowledge about React, components, props, state, and hooks.
...
- Use of React.
- Use of Vite.
- Use of components, props, states, and hooks.
